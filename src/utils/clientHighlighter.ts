...
const TYPESCRIPT_PATTERNS: TokenPattern[] = [
  ...
  // Keywords
  { pattern: /\b(function|class|const|let|var|if|else|for|while|do|switch|case|break|continue|return|throw|try|catch|finally|new|delete|typeof|instanceof|in|of|async|await|yield|import|export|from|default|extends|implements|interface|type|enum|namespace|module|declare|abstract|public|private|protected|static|readonly|override|get|set)\b/g, cssClass: "hl-keyword" },
  
  // Types
  { pattern: /\b(string|number|boolean|void|null|undefined|never|any|unknown|object|symbol|bigint|Array|Object|Function|Promise|Map|Set)\b/g, cssClass: "hl-type" },
  
  // Constants
  { pattern: /\b(true|false|null|undefined|NaN|Infinity)\b/g, cssClass: "hl-constant" },
