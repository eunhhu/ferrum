...
pub fn buffer_insert(
  ...
  buffer.insert(position, &text).map_err(|e| e.to_string())?;
...
/// Get buffer content
#[tauri::command]
pub fn buffer_content(state: State<'_, AppState>, buffer_id: String) -> Result<BufferInfo, String> {
  let id: BufferId = buffer_id
    .parse()
    .map_err(|_| "Invalid buffer ID".to_string())?;
...
/// Undo the last edit
#[tauri::command]
pub fn buffer_undo(state: State<'_, AppState>, buffer_id: String) -> Result<BufferInfo, String> {
  let id: BufferId = buffer_id
    .parse()
    .map_err(|_| "Invalid buffer ID".to_string())?;
...
#[tauri::command]
pub fn buffer_redo(state: State<'_, AppState>, buffer_id: String) -> Result<BufferInfo, String> {
  let id: BufferId = buffer_id
    .parse()
    .map_err(|_| "Invalid buffer ID".to_string())?;
