...
/// Stop an LSP server
#[tauri::command]
pub async fn lsp_stop(_state: State<'_, AppState>, language: String) -> Result<(), String> {
...
#[tauri::command]
pub fn lsp_status(_state: State<'_, AppState>, language: String) -> LspStatus {
...
#[tauri::command]
pub async fn lsp_did_close(_state: State<'_, AppState>, _file_path: String) -> Result<(), String> {
  // TODO: Forward to LSP client
  Ok(())
}
